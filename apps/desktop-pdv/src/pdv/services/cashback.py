...
class CashbackService:
    ...
    def configure(self, *, percent: Decimal, max_per_sale_cents: Cents,
                  validity_days: int) -> CashbackRule:
...
__all__ = ["CashbackCredit", "CashbackError", "CashbackRule", "CashbackService"]
